...
export const OpenAIFunctionSchema = z.object({
  ...
  parameters: z.object({ type: z.literal('object'), properties: z.record(z.any()), required: z.array(z.string()).optional() }).optional(),
});

export const OpenAIToolSchema = z.object({ type: z.literal('function'), function: OpenAIFunctionSchema });

export const OpenAIToolCallSchema = z.object({ id: z.string(), type: z.literal('function'), function: z.object({ name: z.string(), arguments: z.string() }) });
...
export const OpenAIChatCompletionRequestSchema = z.object({
  ...
  tool_choice: z.union([ z.enum(['none', 'auto']), z.object({ type: z.literal('function'), function: z.object({ name: z.string() }) }) ]).optional(),
});
